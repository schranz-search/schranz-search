...
namespace Schranz\Search\SEAL\Adapter\Zinc;

use Zinc\Client;
use Zinc\Exceptions\ApiException;
...
final class ZincConnection implements ConnectionInterface
{
    ...
    public function search(Search $search): Result
    {
        ...
        if (count($search->indexes) !== 1) {
            throw new \RuntimeException('Zinc does not yet support search multiple indexes: https://github.com/schranz-search/schranz-search/issues/28');
        }
