...
$diConfig[IndexCreateCommand::class] = static function (ContainerInterface $container) use () {
    $engineRegistry = $container->get(EngineRegistry::class);

    return new IndexCreateCommand($engineRegistry);
};

$diConfig[IndexDropCommand::class] = static function (ContainerInterface $container) use () {
    $engineRegistry = $container->get(EngineRegistry::class);
